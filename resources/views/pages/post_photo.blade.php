...
@section('content')
    <div class="d-flex justify-content-center">
        <div class="w-25 my-5 rounded p-4 shadow-lg">
            ...
            @csrf
            <div class="mb-3">
                <input class="form-control" type="file" id="formFile" accept="image/jpg,image/png" name="photo" aria-label="photo upload">
                @error('photo')
              ...
              <div class="d-flex justify-content-center mb-2"><button type="submit" class="btn btn-prymari">POST</button>
              </div>
